  ...
  const products = {
    ...
    return (
      <>
        ...
        <Home mode={mode} />
        {/* <ProductPage id={products.id} title={products.title} combination={products.combination} discription={products.discription} indication={products.indication} mrp={products.mrp} /> */}
        <Footer />
